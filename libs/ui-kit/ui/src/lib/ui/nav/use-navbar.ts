...
import { NavbarSlots, NavbarVariantProps, navbar } from './styles';

interface Props extends HTMLProps<'nav'> {
  /**
   * Ref to the DOM node.
   */
   ...
   * Used to determine the scroll position and visibility of the navbar.
   * @default `window``
   */
